...
import pandas as pd
from uktxgnn.collectors import DrugBundleAggregator
from uktxgnn.paths import get_bundles_dir, slugify
...
def preload_predictions(min_score: float = 0.99, top_n: int = 10) -> dict[str, list]:
    ...
    """
    from uktxgnn.collectors.drug_bundle import PredictedIndication
    from uktxgnn.collectors.known_relations import KnownRelationsChecker
...
def patch_single_drug(
    ...
    """
    from uktxgnn.collectors.drug_bundle import DrugBundle
