#!/usr/bin/env python3
"""Generate FHIR R4 resources for UkTxGNN predictions.

This script generates MedicationKnowledge and ClinicalUseDefinition
resources for the UK drug repurposing predictions.
"""
...
BASE_URL = "https://uktxgnn.yao.care"
JURISDICTION = "GB"
PUBLISHER = "yao.care"
VERSION = "0.1.0"
...
def main():
    print("=" * 60)
    print("UkTxGNN - Generate FHIR R4 Resources")
    print("=" * 60)
    print()
    ...
    capability = {
        ...
        "version": VERSION,
        "name": "UkTxGNNServer",
        "title": "UkTxGNN FHIR Server",
        "status": "active",
        "experimental": True,
        "date": datetime.now(timezone.utc).strftime("%Y-%m-%d"),
        "publisher": PUBLISHER,
        "description": "FHIR R4 server for UK drug repurposing predictions using TxGNN",
        "jurisdiction": [
            {
                "coding": [
                    {
