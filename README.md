# UkTxGNN - UK: Drug Repurposing

> 本專案由 **藥提醒科技有限公司**（[yao.care](https://www.yao.care)）開發與維運。
> UkTxGNN 站台：<https://uktxgnn.yao.care/>｜產品總覽：<https://www.yao.care/medical/txgnn/>

[![Website](https://img.shields.io/badge/Website-uktxgnn.yao.care-blue)](https://uktxgnn.yao.care)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

Drug repurposing predictions for United Kingdom MHRA-approved drugs using the TxGNN model.
...
| **DHI Data** | 35 |
| **DDSI Data** | 8,359 |
| **FHIR Resources** | 701 MK / 50,000 CUD |
...
| **L5** | 701 | Computational prediction only |
...
| Metric | Value |
|------|------|
| MHRA Total Drugs | 9,616 |
| Repurposing Candidates | 11,958,054 |

### Deep Learning Method

```bash
conda activate txgnn
PYTHONPATH=src python -m uktxgnn.predict.txgnn_model
```

| Metric | Value |
|------|------|
| Total DL Predictions | 1,196,718 |
| Unique Drugs | 701 |
| Unique Indications | 17,081 |
...
flowchart TD
    ...
    subgraph B["Step 1: DrugBundle Collector"]
        B1["Drug-level: MHRA, DDI, DrugBank"]
...
| File | Download |
|------|------|
| MHRA Data | [Data Source](https://products.mhra.gov.uk/) |
...
|------|------|------|------|
| **Drug Data** | MHRA | [MHRA](https://products.mhra.gov.uk/) | United Kingdom |
...
```mermaid
flowchart TD
    FDA["MHRA Data"] --> proc["process_fda_data.py"]
    TxGNN["TxGNN Data"] --> prep["prepare_external_data.py"]

    proc --> json["uk_fda_drugs.json"]
...
```bibtex
@software{uktxgnn2026,
  author       = {Yao.Care},
  title        = {UkTxGNN: Drug Repurposing Validation Reports for United Kingdom MHRA Drugs},
  year         = 2026,
  publisher    = {GitHub},
  url          = {https://github.com/yao-care/UkTxGNN}
}
```
