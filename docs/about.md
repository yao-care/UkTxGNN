...
nav_order: 90
permalink: /about/
description: "UkTxGNN is a drug repurposing prediction platform developed by 藥提醒科技有限公司 (yao.care), built on the Harvard TxGNN model, covering MHRA-approved medicines in United Kingdom."
---
...
<p class="key-answer" data-question="What is UkTxGNN?">
<strong>UkTxGNN</strong> is a research-support platform for drug repurposing, built on the TxGNN
model published in <em>Nature Medicine</em> by the Zitnik Lab at Harvard University. It predicts
indication expansion for medicines approved by MHRA in United Kingdom. Beyond AI prediction scores,
...
UkTxGNN is the United Kingdom site of the company's "TxGNN Drug Repurposing" product line.
...
<tr><td>Registration data</td><td><a href="https://www.gov.uk/mhra">MHRA</a></td><td>Drug approval data for United Kingdom</td></tr>
</tbody>
</table>
...
- **GitHub Issues**: <https://github.com/yao-care/UkTxGNN/issues>
