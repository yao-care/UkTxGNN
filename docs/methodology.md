...
description: "How UkTxGNN produces and validates predictions: TxGNN knowledge graph prediction, evidence collection, L1-L5 grading, and decision recommendations."
---
...
<p class="key-answer" data-question="How does UkTxGNN produce its predictions?">
...
<li><strong>Evidence collection</strong>: for each predicted pair, evidence is gathered from ClinicalTrials.gov, PubMed, DrugBank and MHRA.</li>
...
Drug approval data for United Kingdom comes from MHRA. Ingredient names are mapped to the
