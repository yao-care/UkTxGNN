...
Epinastine currently holds **no marketing authorisation** in this jurisdiction (`market_status: Not marketed` / Not marketed; `total_licenses: 0`). No product entries are available to tabulate.
