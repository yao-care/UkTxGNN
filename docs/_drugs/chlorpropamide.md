...
Chlorpropamide is a first-generation sulfonylurea historically used for the management of type 2 diabetes mellitus.
The TxGNN model has **not generated any predicted new indications** for this drug,
and the evidence pack contains **no clinical trials** or **publications** to support repurposing at this time.
